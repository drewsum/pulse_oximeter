...
F 7 "RMCF0402FT1K00CT-ND" H 3520 3570 60  0001 C CNN "Digi-Key PN"
	1    3220 3170
	-1   0    0    -1  
$EndComp
$Comp
...
AR Path="/5EAE4ADE/5CB897A9" Ref="#PWR01805"  Part="1" 
F 0 "#PWR01805" H 2650 3590 50  0001 C CNN
...
AR Path="/5EAE4ADE/5CB930FF" Ref="C1803"  Part="1" 
F 0 "C1803" H 6565 3150 50  0000 L CNN
F 1 "0.1uF" H 6565 2950 50  0000 L CNN
F 2 "Capacitors_SMD:C_0402" H 6578 2900 50  0001 C CNN
F 3 "" H 6565 3150 50  0001 C CNN
F 4 "490-10698-1-ND" H 6965 3550 60  0001 C CNN "Digi-Key PN"
F 5 "0402" H 6390 3150 50  0000 R CNN "display_footprint"
F 6 "25V" H 6390 3050 50  0000 R CNN "Voltage"
...
F 7 "RMCF0402FT1K00CT-ND" H 7520 3570 60  0001 C CNN "Digi-Key PN"
	1    7220 3170
	-1   0    0    -1  
$EndComp
$Comp
...
AR Path="/5EAE4ADE/5CB93124" Ref="#PWR01816"  Part="1" 
F 0 "#PWR01816" H 7220 2870 50  0001 C CNN
...
AR Path="/5EAE4ADE/5CB9312E" Ref="#PWR01814"  Part="1" 
F 0 "#PWR01814" H 6650 3490 50  0001 C CNN
...
AR Path="/5EAE4ADE/5CB93138" Ref="#PWR01812"  Part="1" 
F 0 "#PWR01812" H 6540 2750 50  0001 C CNN
...
AR Path="/5EAE4ADE/5CB93142" Ref="#PWR01815"  Part="1" 
F 0 "#PWR01815" H 6650 3590 50  0001 C CNN
...
AR Path="/5EAE4ADE/5CB9314C" Ref="#PWR01813"  Part="1" 
F 0 "#PWR01813" H 6540 2950 50  0001 C CNN
...
AR Path="/5EAE4ADE/5CB97030" Ref="C1804"  Part="1" 
F 0 "C1804" H 8565 3150 50  0000 L CNN
F 1 "0.1uF" H 8565 2950 50  0000 L CNN
F 2 "Capacitors_SMD:C_0402" H 8578 2900 50  0001 C CNN
F 3 "" H 8565 3150 50  0001 C CNN
F 4 "490-10698-1-ND" H 8965 3550 60  0001 C CNN "Digi-Key PN"
F 5 "0402" H 8390 3150 50  0000 R CNN "display_footprint"
F 6 "25V" H 8390 3050 50  0000 R CNN "Voltage"
...
F 7 "RMCF0402FT1K00CT-ND" H 9520 3570 60  0001 C CNN "Digi-Key PN"
	1    9220 3170
	-1   0    0    -1  
$EndComp
$Comp
...
AR Path="/5EAE4ADE/5CB97055" Ref="#PWR01821"  Part="1" 
F 0 "#PWR01821" H 9220 2870 50  0001 C CNN
...
AR Path="/5EAE4ADE/5CB9705F" Ref="#PWR01819"  Part="1" 
F 0 "#PWR01819" H 8650 3490 50  0001 C CNN
...
AR Path="/5EAE4ADE/5CB97069" Ref="#PWR01817"  Part="1" 
F 0 "#PWR01817" H 8540 2750 50  0001 C CNN
...
AR Path="/5EAE4ADE/5CB97073" Ref="#PWR01820"  Part="1" 
F 0 "#PWR01820" H 8650 3590 50  0001 C CNN
...
AR Path="/5EAE4ADE/5CB9707D" Ref="#PWR01818"  Part="1" 
F 0 "#PWR01818" H 8540 2950 50  0001 C CNN
...
AR Path="/5EAE4ADE/5E1829A4" Ref="C1802"  Part="1" 
F 0 "C1802" H 4565 3150 50  0000 L CNN
...
F 5 "25V" H 4390 3050 50  0000 R CNN "Voltage"
F 6 "X7R" H 4390 2950 50  0000 R CNN "Dielectric"
F 7 "490-10698-1-ND" H 4540 3050 50  0001 C CNN "Digi-Key PN"
	1    4540 3050
	-1   0    0    -1  
$EndComp
$Comp
...
F 7 "RMCF0402FT1K00CT-ND" H 5220 3170 50  0001 C CNN "Digi-Key PN"
	1    5220 3170
	-1   0    0    -1  
$EndComp
$Comp
...
AR Path="/5EAE4ADE/5E1829C9" Ref="#PWR01811"  Part="1" 
F 0 "#PWR01811" H 5220 2870 50  0001 C CNN
...
AR Path="/5EAE4ADE/5E1829D3" Ref="#PWR01809"  Part="1" 
F 0 "#PWR01809" H 4650 3490 50  0001 C CNN
...
AR Path="/5EAE4ADE/5E1829DD" Ref="#PWR01807"  Part="1" 
F 0 "#PWR01807" H 4540 2750 50  0001 C CNN
...
AR Path="/5EAE4ADE/5E1829E7" Ref="#PWR01810"  Part="1" 
F 0 "#PWR01810" H 4650 3590 50  0001 C CNN
...
AR Path="/5EAE4ADE/5E1829F1" Ref="#PWR01808"  Part="1" 
F 0 "#PWR01808" H 4540 2950 50  0001 C CNN
...
U 1 1 5FDA8D7E
P 3220 3020
F 0 "#PWR01806" H 3220 2870 50  0001 C CNN
...
F 7 "RMCF0402FT10K0CT-ND" H 2270 4020 50  0001 C CNN "Digi-Key PN"
	1    2270 4020
	1    0    0    -1  
$EndComp
$Comp
...
AR Path="/5EAE4ADE/5FDAEAEC" Ref="#PWR01804"  Part="1" 
F 0 "#PWR01804" H 2650 3490 50  0001 C CNN
...
F 4 "296-SN74LVC1G97DCK3CT-ND" H 4650 3740 50  0001 C CNN "Digi-Key PN"
	1    4650 3740
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5FFD5F36
P 2540 3050
AR Path="/5BAAE1F3/5FFD5F36" Ref="C?"  Part="1" 
AR Path="/5BAAE1CB/5FFD5F36" Ref="C?"  Part="1" 
AR Path="/5BE48F98/5FFD5F36" Ref="C?"  Part="1" 
AR Path="/5CAD2D97/5FFD5F36" Ref="C?"  Part="1" 
AR Path="/5CB7A8BC/5FFD5F36" Ref="C?"  Part="1" 
AR Path="/5CB7A8C3/5FFD5F36" Ref="C?"  Part="1" 
AR Path="/5EAE4ADE/5FFD5F36" Ref="C1801"  Part="1" 
F 0 "C1801" H 2565 3150 50  0000 L CNN
F 1 "0.1uF" H 2565 2950 50  0000 L CNN
F 2 "Capacitors_SMD:C_0402" H 2578 2900 50  0001 C CNN
F 3 "" H 2565 3150 50  0001 C CNN
F 4 "0402" H 2390 3150 50  0000 R CNN "display_footprint"
F 5 "25V" H 2390 3050 50  0000 R CNN "Voltage"
F 6 "X7R" H 2390 2950 50  0000 R CNN "Dielectric"
F 7 "490-10698-1-ND" H 2540 3050 50  0001 C CNN "Digi-Key PN"
	1    2540 3050
	-1   0    0    -1  
$EndComp
$Comp
...
U 1 1 5FFD61E2
P 2540 2900
AR Path="/5CB7A8BC/5FFD61E2" Ref="#PWR?"  Part="1" 
AR Path="/5CB7A8C3/5FFD61E2" Ref="#PWR?"  Part="1" 
AR Path="/5EAE4ADE/5FFD61E2" Ref="#PWR01802"  Part="1" 
F 0 "#PWR01802" H 2540 2750 50  0001 C CNN
F 1 "+3.3V" H 2540 3040 50  0000 C CNN
F 2 "" H 2540 2900 50  0001 C CNN
F 3 "" H 2540 2900 50  0001 C CNN
	1    2540 2900
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5FFD61EC
P 2540 3200
AR Path="/5CB7A8BC/5FFD61EC" Ref="#PWR?"  Part="1" 
AR Path="/5CB7A8C3/5FFD61EC" Ref="#PWR?"  Part="1" 
AR Path="/5EAE4ADE/5FFD61EC" Ref="#PWR01803"  Part="1" 
F 0 "#PWR01803" H 2540 2950 50  0001 C CNN
F 1 "GND" H 2540 3050 50  0000 C CNN
F 2 "" H 2540 3200 50  0001 C CNN
F 3 "" H 2540 3200 50  0001 C CNN
	1    2540 3200
	1    0    0    -1  
$EndComp
$EndSCHEMATC
