...
U 1 1 5E217505
P 5400 2620
F 0 "U2101" H 5100 2970 50  0000 R CNN
...
U 1 1 5E217898
P 5400 3020
F 0 "#PWR02110" H 5400 2770 50  0001 C CNN
...
U 1 1 5E217DBC
P 5400 2220
F 0 "#PWR02109" H 5400 2070 50  0001 C CNN
...
$EndComp
$Comp
L Custom_Library:VBAT #PWR02107
U 1 1 5E2180E2
P 5300 2220
F 0 "#PWR02107" H 5300 2070 50  0001 C CNN
...
U 1 1 5E21E9AC
P 5820 3810
F 0 "C2103" H 5845 3910 50  0000 L CNN
...
$EndComp
$Comp
L power:+3.3V #PWR02111
U 1 1 5E21E9B2
P 5820 3660
F 0 "#PWR02111" H 5820 3510 50  0001 C CNN
...
U 1 1 5E21E9B8
P 5820 3960
F 0 "#PWR02112" H 5820 3710 50  0001 C CNN
...
U 1 1 5E220EDC
P 5090 3810
F 0 "C2101" H 5115 3910 50  0000 L CNN
...
U 1 1 5E220EE8
P 5090 3960
F 0 "#PWR02106" H 5090 3710 50  0001 C CNN
...
$EndComp
$Comp
L Custom_Library:VBAT #PWR02105
U 1 1 5E220F81
P 5090 3660
F 0 "#PWR02105" H 5090 3510 50  0001 C CNN
...
U 1 1 5E990E17
P 7160 3170
F 0 "DOC2101" H 7160 3420 60  0001 C CNN
...
U 1 1 5EA04714
P 1270 5380
F 0 "BT2101" H 1370 5480 50  0000 L CNN
...
U 1 1 5EA0966C
P 2580 5480
F 0 "#PWR02102" H 2580 5230 50  0001 C CNN
...
U 1 1 5EA09B4F
P 2580 5180
F 0 "#PWR02101" H 2580 5030 50  0001 C CNN
...
U 1 1 5EBF49D1
P 2040 5280
F 0 "J2101" H 2040 5380 50  0000 C CNN
...
AR Path="/5EB8C603/5EC31E5F" Ref="R2101"  Part="1" 
F 0 "R2101" H 4530 5220 50  0000 R CNN
...
F 7 "RMCF0402FT10K0CT-ND" H 4610 5220 50  0001 C CNN "Digi-Key PN"
	1    4610 5220
	1    0    0    -1  
$EndComp
$Comp
...
AR Path="/5EB8C603/5EC31E68" Ref="R2102"  Part="1" 
F 0 "R2102" H 4530 5680 50  0000 R CNN
...
F 7 "RMCF0402FT10K0CT-ND" H 4610 5680 50  0001 C CNN "Digi-Key PN"
	1    4610 5680
	1    0    0    -1  
$EndComp
Wire Wire Line
...
AR Path="/5EB8C603/5EC31E79" Ref="C2102"  Part="1" 
F 0 "C2102" H 5335 5780 50  0000 L CNN
...
AR Path="/5EB8C603/5EC31E7F" Ref="#PWR02108"  Part="1" 
F 0 "#PWR02108" H 5310 5580 50  0001 C CNN
...
$Comp
L Custom_Library:VBAT #PWR02103
U 1 1 5EC31F1F
P 4610 5070
F 0 "#PWR02103" H 4610 4920 50  0001 C CNN
...
AR Path="/5EB8C603/5EC35F0F" Ref="#PWR02104"  Part="1" 
F 0 "#PWR02104" H 4610 5980 50  0001 C CNN
...
AR Path="/5EB8C603/5EC35F16" Ref="Q2101"  Part="1" 
F 0 "Q2101" H 4710 6105 50  0000 L CNN
...
U 1 1 5EC3F1A9
P 2910 5180
AR Path="/5C1D5CD8/5EC3F1A9" Ref="TP?"  Part="1" 
AR Path="/5C1D5C9E/5EC3F1A9" Ref="TP?"  Part="1" 
AR Path="/5CB6F1ED/5EC3F1A9" Ref="TP?"  Part="1" 
AR Path="/5E939CFF/5EC3F1A9" Ref="TP?"  Part="1" 
AR Path="/5E9E0E87/5EC3F1A9" Ref="TP?"  Part="1" 
AR Path="/5EAE2D66/5EC3F1A9" Ref="TP?"  Part="1" 
AR Path="/5EB8C603/5EC3F1A9" Ref="TP2101"  Part="1" 
F 0 "TP2101" H 2910 5330 50  0000 C CNN
F 1 "TP" H 2910 5330 50  0001 C CNN
F 2 "Custom Footprints Library:Test_Point" H 2910 5180 60  0001 C CNN
F 3 "" H 2910 5180 60  0000 C CNN
	1    2910 5180
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	2910 5280 2580 5280
Connection ~ 2580 5280
$Comp
L power:PWR_FLAG #FLG0103
U 1 1 5EC3F51F
P 3300 5180
F 0 "#FLG0103" H 3300 5255 50  0001 C CNN
F 1 "PWR_FLAG" H 3300 5330 50  0000 C CNN
F 2 "" H 3300 5180 50  0001 C CNN
