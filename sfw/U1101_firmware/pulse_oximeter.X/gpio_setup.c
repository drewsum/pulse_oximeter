...
void portBGPIOInitialize (void) {
    gpioPinSetup(PORTB, 0, TRIS_OUTPUT, LAT_LOW, ODC_DISABLE, ANALOG_DISABLE);
    gpioPinSetup(PORTB, 1, TRIS_OUTPUT, LAT_LOW, ODC_DISABLE, ANALOG_DISABLE);
    gpioPinSetup(PORTB, 2, TRIS_INPUT, LAT_LOW, ODC_DISABLE, ANALOG_DISABLE);
    gpioPinSetup(PORTB, 3, TRIS_INPUT, LAT_LOW, ODC_DISABLE, ANALOG_DISABLE);
    ...
    gpioPinSetup(PORTB, 8, TRIS_OUTPUT, LAT_LOW, ODC_DISABLE, ANALOG_DISABLE);
    gpioPinSetup(PORTB, 9, TRIS_OUTPUT, LAT_LOW, ODC_DISABLE, ANALOG_DISABLE);
    ...
    gpioPinSetup(PORTB, 12, TRIS_OUTPUT, LAT_LOW, ODC_DISABLE, ANALOG_DISABLE);
    gpioPinSetup(PORTB, 13, TRIS_OUTPUT, LAT_LOW, ODC_DISABLE, ANALOG_DISABLE);
    gpioPinSetup(PORTB, 14, TRIS_OUTPUT, LAT_LOW, ODC_DISABLE, ANALOG_DISABLE);
    gpioPinSetup(PORTB, 15, TRIS_OUTPUT, LAT_LOW, ODC_DISABLE, ANALOG_DISABLE);
}
...
void portCGPIOInitialize (void) {
    ...
    RPC13Rbits.RPC13R = 0b1111;         // Assign REFCLKO1 to RC13
    gpioPinSetup(PORTC, 14, TRIS_OUTPUT, LAT_LOW, ODC_DISABLE, ANALOG_DISABLE);
...
void portDGPIOInitialize (void) {
    gpioPinSetup(PORTD, 0, TRIS_INPUT, LAT_LOW, ODC_DISABLE, ANALOG_DISABLE);
    gpioPinSetup(PORTD, 1, TRIS_OUTPUT, LAT_LOW, ODC_DISABLE, ANALOG_DISABLE);
    gpioPinSetup(PORTD, 2, TRIS_INPUT, LAT_LOW, ODC_DISABLE, ANALOG_DISABLE);
    U1RXRbits.U1RXR = 0b0000;           // Assign U1RX to RD2
    gpioPinSetup(PORTD, 3, TRIS_OUTPUT, LAT_LOW, ODC_DISABLE, ANALOG_DISABLE);
    RPD3Rbits.RPD3R = 0b0001;           // Assign U1TX to RD3
    ...
    gpioPinSetup(PORTD, 10, TRIS_OUTPUT, LAT_LOW, ODC_DISABLE, ANALOG_DISABLE);
...
void portFGPIOInitialize (void) {
    ...
    gpioPinSetup(PORTF, 4, TRIS_INPUT, LAT_HIGH, ODC_ENABLE, ANALOG_DISABLE);
    gpioPinSetup(PORTF, 5, TRIS_INPUT, LAT_HIGH, ODC_ENABLE, ANALOG_DISABLE);
}
