...
void powerMonitorsInitialize(void) {
    ...
    INA219PowerMonitorInitialize(POS1P8_MON_ADDR, &error_handler.flags.pos1p8_mon);
    ...
    INA219SetCalibration(POS1P8_MON_ADDR, &error_handler.flags.pos1p8_mon, POS1P8_MON_CLSB, POS1P8_MON_RSHUNT);
...
void powerMonitorsGetData(void) {
    ...
    telemetry.pos1p8.voltage        = INA219GetVoltage(POS1P8_MON_ADDR, &error_handler.flags.pos1p8_mon);
    ...
    telemetry.pos1p8.current        = INA219GetCurrent(POS1P8_MON_ADDR, &error_handler.flags.pos1p8_mon, POS1P8_MON_CLSB);
    ...
    telemetry.pos1p8.power        = INA219GetPower(POS1P8_MON_ADDR, &error_handler.flags.pos1p8_mon, POS1P8_MON_CLSB);
...
void printPowerMonitorStatus(void) {
    ...
    INA219printStatus(POS1P8_MON_ADDR, &error_handler.flags.pos1p8_mon);
